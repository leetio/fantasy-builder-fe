...
export const LeagueCard: React.FC<ILeagueCard> = observer(({league}) => {
	const {i18n, isManagerShow, leagueLink} = useViewController<ILeagueCardController>(
	...
	return (
		<NavLink key={league.id} to={leagueLink}>
					...
					<FlexContainer>
						...
						<Box p={2}>
							...
							<Stack direction="row" spacing={1.5}>
								...
								<Exist when={league.status === LeagueStatus.SCHEDULED}>
									<TextBlock>
										<Typography variant="caption" fontWeight={"bold"}>
											{i18n.t("league_card.label.start", "Starts")}:
										</Typography>
										<Typography variant="caption" fontWeight={"normal"}>
											{league.startId}
										</Typography>
